 ...
 * @date 18 Sep 2021
 * @brief A simple implementation of a basic linked list and some functions to go with it.
 *
*/
...
/// @return an empty linked list, whose first link is stored in head, and last link is stored in last.
